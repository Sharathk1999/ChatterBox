...
const backgroundColor = Color.fromRGBO(74, 82, 85, 1);
const textColor = Color.fromRGBO(241, 241, 242, 1);
const appBarColor = Color.fromRGBO(52, 53, 53, 1);
const webAppBarColor = Color.fromRGBO(42,47,50,1);
const messageColor = Color.fromRGBO(104, 106, 106, 1);
const senderMessageColor = Color.fromRGBO(37, 45, 49, 1);
const tabColor = Color.fromRGBO(132, 134, 133, 1);
